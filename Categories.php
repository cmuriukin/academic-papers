...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Writing Centre - Categories</title>
...
#apDiv4 {
	...
	font-size: 9px;
        ...
        #mainbg #header #main #content #center .text table tr td p strong {
	color: #0000FF;
}
        #mainbg #header #main #content #center .text table tr td h4 strong em {
	color: #0000FF;
}
        .a {
	color: #000066;
...
<!--End Comm100 Live Chat Code-->
                        ...
                        <div class="right_bot">
                          ...
                          <div>
                                <div class="right_bg">
                                  <div class="right_grad">
                                    <div style="color:#003366" class="recent"></div>
...
<li><strong>Mathematics and Economics </strong></li>
<li><strong>Arts </strong></li>
<li><strong>Essay Writing Tips </strong></li>
<li><strong>Nursing </strong></li>
<li><strong>Literature and Languages </strong></li>
...
<tr>
<td valign="top">
<p><strong>&nbsp;<img src="images/Offer.jpg" alt="" width="515" height="242" /></strong></p>
</td>
</tr>
</tbody>
</table>
...
<p>&nbsp;</p>
<div>
<div style="text-align: center;"><a href="Order Form.php"><img src="images/discount button.png" alt="" width="496" height="117" /></a></div>
</div>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<div id="apDiv4">
<div>
<p align="left"><strong>ritingcentre.us</strong></p>
</div>
</div>
</div>
